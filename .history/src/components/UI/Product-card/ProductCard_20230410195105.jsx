  ...
  return (
    <div className='product_item w-full aspect-w-1 aspect-h-1 bg-gray-200 rounded-lg overflow-hidden xl:aspect-w-7 xl:aspect-h-8'>
        ...
        <div className="product_content">
            ...
            <h5><Link href={`/products/${id}`} className='mt-4 text-sm text-gray-700'>{post_title}</Link></h5>
            <div className='d-flex align-items-center justify-content-between'>
                {/* <span className='product_price'>$15.00</span> */}
                <span className='product_price mt-1 text-lg font-medium text-gray-900'><b>${price}</b></span>
