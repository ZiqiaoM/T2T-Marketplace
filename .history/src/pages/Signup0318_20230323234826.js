...
export default function SignUp() {
  ...
  return (
    ...
    <p className="mt-2 text-center text-sm text-gray-600">Hey, there. Welcome to join us! We&aposre thrilled to have you join us and can't wait to see all the great things you'll bring to the table.</p>
