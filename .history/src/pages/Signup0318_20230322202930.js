...
export default function SignUp() {
  ...
  return (
    ...
    <div className="container2 bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
    <div className='form'>
    <form onSubmit={handleSubmit}>
      ...
      <div className='nd_signin'><Link href='/Login'><p>Already have an account? <br/> Back to Login</p></Link></div>
